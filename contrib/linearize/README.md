# Linearize
Construct a linear, no-fork, best version of the Dak blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install dak_hash

https://github.com/dakpay/dak_hash
...
JSON-RPC server. Running `dakd` or `dak-qt -server` will be sufficient.
...
* `input`: dakd blocks/ directory containing blkNNNNN.dat
