...
This document provides guidelines for internationalization of the Dak Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dak_en.ts` remains unchanged.
