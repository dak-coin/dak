...
This mechanism has been integrated into Bitcore-Node-Dak which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dakpay/insight-api-dak#web-socket-api](https://github.com/dakpay/insight-api-dak#web-socket-api)
* API: [https://github.com/dakpay/insight-api-dak#instantsend-transactions](https://github.com/dakpay/insight-api-dak#instantsend-transactions)
...
By default, the Dak Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dak Core daemon:
