...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Dak address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "dak",               "masternode",             &masternode,             true,  {} },
    { "dak",               "masternodelist",         &masternodelist,         true,  {} },
    { "dak",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "dak",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "dak",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "dak",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
