...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in dak.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("dak.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Dak features */
    { "dak",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "dak",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "dak",               "gobject",                &gobject,                true,  {} },
    { "dak",               "voteraw",                &voteraw,                true,  {} },
