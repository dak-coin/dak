    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DAK-light"), QVariant("light"));
    ui->theme->addItem(QString("DAK-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DAK-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("DAK-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("DAK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DAK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DAK-traditional"), QVariant("trad"));
